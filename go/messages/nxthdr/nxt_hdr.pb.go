...
// may not) be the same as the "dest" field. For example if the dest field is a
// private service like kismis.org, the destAgent will be the same as
// kismis.org. But if the dest field is say google.com, then the destAgent can
// be set to say default-internet. In other words, destAgent gives the sender
// (agent/connector) flexibility to either say "route to whoever provides
...
// in clusters and connectors, agents dont fill it or use it
//
...
var file_nxt_hdr_proto_rawDesc = []byte{
	...
	0x06, 0x6e, 0x78, 0x74, 0x68, 0x64, 0x72, 0x22, 0xc0, 0x01, 0x0a, 0x0a, 0x4e, 0x78, 0x74, 0x4f,
	...
	0x09, 0x52, 0x07, 0x70, 0x6f, 0x64, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xb5, 0x03, 0x0a, 0x07, 0x4e,
	...
	0x65, 0x72, 0x50, 0x6f, 0x64, 0x22, 0x1b, 0x0a, 0x09, 0x46, 0x4c, 0x4f, 0x57, 0x5f, 0x54, 0x59,
