...
type NxtTrace struct {
	...
	WireSpanStartTime string `protobuf:"bytes,2,opt,name=wireSpanStartTime,proto3" json:"wireSpanStartTime,omitempty"`
...
func (x *NxtTrace) GetWireSpanStartTime() string {
	if x != nil {
...
var file_nxt_hdr_proto_rawDesc = []byte{
	...
	0x54, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x77, 0x69, 0x72, 0x65,
	...
	0x28, 0x09, 0x52, 0x11, 0x77, 0x69, 0x72, 0x65, 0x53, 0x70, 0x61, 0x6e, 0x53, 0x74, 0x61, 0x72,
